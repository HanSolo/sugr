...
class RestController {
    ...
    public static func getGlucoseData(url: String, apiSecret: String, token: String, useApiV2: Bool, numberOfEntries: Int, inBackground: Bool) async -> [GlucoEntry]? {
        ...
        let sessionConfig : URLSessionConfiguration = inBackground ? URLSessionConfiguration.background(withIdentifier: Constants.APP_REFRESH_ID) : URLSessionConfiguration.default
